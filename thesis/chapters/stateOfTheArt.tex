...
Als resultaat vinden we de volgende visualisatie\ref{fig:coarsevsfine}. Hierbij is rood de trace met fine probleem en blauw coarse permissies. Waaruit we kunnen concluderen dat bovenop de inherente onnauwkeurigheid ook nog extra obfuscatie gebeurd.
\begin{figure}[h]
    \centering
...
\begin{figure}[h]
    ...
    \caption{Vergelijking coarse permissie op één apparaat}
    \label{fig:coarse_1_phone}
\end{figure}
\begin{figure}[h]
    \centering
    ...
    \caption{Vergelijking coarse permissie op meerdere apparaten}
    \label{fig:coarse_3_phones}
\end{figure}
