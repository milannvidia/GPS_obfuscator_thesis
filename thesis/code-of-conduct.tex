...
\begin{itemize}
    ...
    \item[$\Checkedbox$] I did use GenAI assistance. In this case, specify which ones (e.g., ChatGPT, \ldots): \underline{Github Copilot}
\end{itemize}

\section*{GenAI Assistance Used As/For}
\begin{itemize}
    \item[$\Box$] MS Copilot \\
    \item[$\Checkedbox$] Language assistance \\
