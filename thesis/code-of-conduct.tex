...
Promoter: prof. dr. Vincent Naessens\\
Daily supervisor: dr. ing. Michiel Willocx
\makeatother
...
\begin{itemize}
    ...
    \item[\(\boxtimes\)] I did use GenAI assistance. In this case, specify which ones (e.g., ChatGPT, \ldots): \underline{Github Copilot}
\end{itemize}
