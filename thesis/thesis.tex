...
\usepackage[backend=biber, style=ieee, citestyle=numeric-comp, maxnames=99]{biblatex}  % make use of the biblatex package to cite references
...
\opleiding{Master in de industriële wetenschappen}
\afdeling{elektronica-ICT: smart applications}
...
\promotorA[Promotor(en)]{prof. dr. Vincent Naessens} %for English use Supervisor(s)
\promotorB[Co-promotor(en)]{dr. ing. Michiel Willocx}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Example citation to ensure bibliography is not empty
\printbibliography
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
\input{chapters/Code_obfuscatie.tex}
\input{chapters/Code_dtw.tex}
...
\includepdf[pages=-]{chapters/Wetenschappelijk_artikel_24_25.pdf}

% Bijlage met daarin de poster
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Poster}
\includepdf{chapters/Poster_Milan_Schollier.pdf}
